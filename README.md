# 👋 Привет! Меня зовут Адель, я продуктовый аналитик с бэкграундом в прикладной математике и маркетплейсе
...
🎓 Выпускница Казанского федерального университета по направлению *Информационные системы и технологии*. Сейчас работаю в направлении коммерческой и B2B-аналитики Магнит Маркета(ex.KazanExpress). Занимаюсь аналитикой продавцов, товаров, заказов, акций, партнёрских каналов, рекламных продуктов, финансовых расчётов и пользовательских сценариев в личном кабинете продавца. Более 3 лет работала программистом-математиком в компании **Sofoil**, где занимаюсь расчётами и визуализацией данных по нефтегазовым месторождениям.
